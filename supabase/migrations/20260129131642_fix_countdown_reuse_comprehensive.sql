/*
  # Fix Countdown Reuse - Comprehensive Solution

  ## Changes
  Complete rewrite of record_heartbeat_and_check_auto_checkout to ensure:
  1. Source of truth is DB state with server timestamps
  2. When violation starts → create NEW pending with fresh started_at
  3. When violation resolves → CANCEL pending completely
  4. New violation after resolve → starts from FULL grace time
  5. No reusing old pending records
*/
