/*
  # Fix Auto-Checkout Countdown Fresh Start

  ## Problem
  Auto-checkout countdown was potentially resuming from old remaining time after recovery.

  ## Solution
  Delete any old CANCELLED entries before creating new PENDING entry.
  This ensures every new violation starts with FRESH ends_at from NOW.

  ## Changes
  - Update record_heartbeat_and_check_auto_checkout function
  - Add DELETE statement to clean up old CANCELLED entries
  - Ensures countdown always starts from full configured duration
*/
