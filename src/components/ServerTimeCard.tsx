...
export default function ServerTimeCard({
  ...
  return (
    <div className="bg-white border-0 border-l-4 border-l-blue-600 rounded-[1.5rem] shadow-sm p-8 overflow-hidden mb-0 transition-all duration-300 min-h-[160px] flex flex-col justify-center relative z-10 w-full">
